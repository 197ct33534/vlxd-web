...
<title>CMS Inc. - Import Invoice Mobile</title>
...
<span class="material-icons-outlined text-primary text-2xl">description</span>
</div>
<div class="flex-1 overflow-hidden">
<p class="text-sm font-medium text-slate-700 dark:text-slate-200 truncate">Nhấn để chọn tệp tin</p>
<p class="text-[11px] text-slate-500 dark:text-slate-400">Excel tối đa 10MB</p>
</div>
<input accept=".xlsx, .xls" class="hidden" id="file-upload" type="file"/>
<span class="material-icons-outlined text-slate-400">attach_file</span>
</label>
</div>
</div>
